...
import core1_2_3.CellType;
import core1_2_3.FrameSkeleton;
import core1_2_3.ImageGrid;
import core1_2_3.ImageSpace;
import core1_2_3.ImageSpace.Texture;
...
* @since   2016-07-15 
*/
public class FrameSkeleton_MethodTest1_2_3 extends FrameSkeleton implements Observer{		/* STEP 1 - ERBEN */
	...
	public static void main(String[] args) {						/* STEP 2 - WERTE des Grids INITIALISIEREN*/
		new FrameSkeleton_MethodTest1_2_3(50, 12, 12);
	}
	
	public FrameSkeleton_MethodTest1_2_3(int cellsize, int gridW, int gridH) {
...
//		setGridlineVisible(true);
		...
		CellType[] ground = iGrid.addNewTextureCellTypes("ground", 5, 16, 16, "C:\\Users.\\Anwender\\Google Drive\\devel\\workspace-jee\\FrameSkeleton1.2\\res\\cell_res1.png");
		
		CellType[] ent = iSpace.addNewTextureCellTypes("ent", 3, 32, 32, "C:\\Users.\\Anwender\\Google Drive\\devel\\workspace-jee\\FrameSkeleton1.2\\res\\cell_res2.png");
		CellType tree = ent[2];
		CellType player0 = ent[0];
		CellType player1 = ent[1];
		
		CellType[] item = iSpace.addNewTextureCellTypes("item", 3, 32, 32, "C:\\Users.\\Anwender\\Google Drive\\devel\\workspace-jee\\FrameSkeleton1.2\\res\\cell_res3.png");
		CellType shild0 = item[0];
		CellType shild1 = item[1];
		CellType sword = item[2];
		
		CellType dude = iSpace.addNewTextureCellType("dude", "C:\\Users.\\Anwender\\Google Drive\\devel\\workspace-jee\\FrameSkeleton1.2\\res\\Dude.png");
		
		for (int i = 0; i <iGrid.getWidth(); i++) {
			for (int j = 0; j < iGrid.getHeight(); j++) {
				
				iGrid.fillCell(ground[4], i, j);
		...
		iSpace.putTexture(tree, 4, 4, 1, 2);
